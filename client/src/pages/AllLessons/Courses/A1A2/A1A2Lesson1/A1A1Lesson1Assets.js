...
export const P2tableData = {
  tableHead: ['Do', 'Does', 'Did', 'Done', 'Doing'],
  tableRowData: [
    [
      { text: 'Walk' },
      { text: 'Walks' },
    ...
    [
      { text: 'Sit' },
      { ans: ['Sits'], eventName: 'table5' },
      { ans: ['Sat'], eventName: 'table6' },
      { ans: ['Sat'], eventName: 'table7' },
      { ans: ['Sitting'], eventName: 'table8' },
    ],
    [
      { text: 'Listen' },
      { ans: ['Listens'], eventName: 'table9' },
      { ans: ['Listened'], eventName: 'table10' },
      { ans: ['Listened'], eventName: 'table11' },
      { ans: ['Listening'], eventName: 'table12' },
    ],
  ],
};

export const P2exerciseData = [
  {
    before: '',
    ans: ['do'],
  ...
  },
  {
    before: '',
    ans: ['does'],
    after: 'he like to stand?',
  },
  {
    before: '',
    ans: ['does'],
    after: 'she want to run?',
  },
  {
    before: '',
    ans: ['do'],
    after: 'we want to listen?',
  },
  {
    before: '',
    ans: ['do'],
    after: 'they like to talk?',
  },
  {
    before: 'Yes, you',
    ans: ['do'],
